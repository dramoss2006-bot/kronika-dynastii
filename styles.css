...
<head>
  ...
  <title>Kronika Dynastii v0.5.1 — P1/P2 + AI Kronikarz</title>
  ...
  <div class="page-shell">
    ...
    <main class="app">
      <header class="topbar">
        ...
        <div class="profile"><div class="avatar" id="ruler-initial">B</div><div><small>Władca</small><strong id="ruler-name">Ładowanie…</strong></div></div>
      </header>

      <nav class="nav-tabs" aria-label="Główna nawigacja">
        <button data-view="home" class="active">⌂ Strona główna</button>
        <button data-view="dynasties">♜ Dynastie</button>
        <button data-view="characters">♙ Postacie</button>
        <button data-view="chronicle">▤ Kronika</button>
        <button data-view="players">♟ Dane P1/P2</button>
        <button data-view="map">🗺 Mapa</button>
        <button data-view="wars">⚔ Wojny</button>
        <button data-view="downloads">⬇ Pobierz</button>
      </nav>
      ...
      <div id="app-content" hidden>
        ...
        <section class="view" id="view-dynasties"></section>
        <section class="view" id="view-characters"></section>
        <section class="view" id="view-chronicle"></section>
        <section class="view" id="view-players"></section>
        <section class="view" id="view-map"></section>
        <section class="view" id="view-wars"></section>
        <section class="view" id="view-downloads"></section>
      </div>
    </main>
  </div>
  <script src="data/campaign-data.js"></script>
  <script src="data/analyzer-live.js"></script>
